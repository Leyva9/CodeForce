...
// and the ripest one, in their opinion. After that the watermelon was weighed, and the scales showed w kilos. 
...
// Output
// Print YES, if the boys can divide the watermelon into two parts, each of them weighing even number 
// of kilos; and NO in the opposite case.
internal class Program
{
    private static void Main(string[] args)
    {
        int weight = Convert.ToInt32(Console.ReadLine());
        if(weight%2 == 0 && weight != 0 && weight <= 100 && weight != 2)
        {
